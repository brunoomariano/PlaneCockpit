import { matchesKey, type TuiKey } from "./key-spec.js";
...
// `input` and `key` are the two halves of a single normalized TUI keystroke;
// keeping them as separate params mirrors the dashboard callback, so the param
// cap is waived.
